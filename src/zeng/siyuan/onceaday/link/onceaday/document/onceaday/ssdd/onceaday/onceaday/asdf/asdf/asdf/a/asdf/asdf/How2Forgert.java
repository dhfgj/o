package zeng.siyuan.onceaday.link.onceaday.document.onceaday.ssdd.onceaday.onceaday.asdf.asdf.asdf.a.asdf.asdf;

import zeng.siyuan.C1comehere.C1comehere;
import zeng.siyuan.onceaday.link.onceaday.DecendingTask;
import zeng.siyuan.onceaday.link.onceaday.document.onceaday.ssdd.onceaday.onceaday.asdf.asdf.a.asdf.asdf.Display;
import zeng.siyuan.onceaday.link.onceaday.document.onceaday.ssdd.onceaday.onceaday.asdf.asdf.a.asdf.asdf.Task;
import zeng.siyuan.onceaday.link.onceaday.document.onceaday.ssdd.onceaday.onceaday.asdf.asdf.a.asdf.asdf.peoplequesiton;
import zeng.siyuan.onceaday.link.onceaday.document.onceaday.ssdd.onceaday.onceaday.asdf.asdf.a.asdf.asdf.person_question;
...
public class How2Forgert implements Serializable {
    ...
    public void loadTask() {
        ...
        if (null !=tasks && tasks.size()>=2)Collections.sort(tasks, new Task());
    }

    public void d(person_question k) {
//        ebbinghauses = (CopyOnWriteArrayList<person_question>) m.getlatest();
//        tasks = new CopyOnWriteArrayList<Task>();
//        for (person_question e : ebbinghauses) {
//            if (e.text.replace("Dufgt", "").trim().isEmpty()){
