...
public class TimePicker extends AbstractPicker {
    ...
    public TimePicker(final JTextArea field, String format) {
        if (format != null){
            this.format = format;
        }
        this.field = field;
        ...
        this.field.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent event) {
                ...
                loli.datepicker.TimePanel timePanel = new loli.datepicker.TimePanel(TimePicker.this);
     ...
     * @return text field
     */
    public static JTextArea getTimeField() {
     ...
     */
    public static JTextArea getDateField(String format) {
        JTextArea field = new JTextArea();
        field.setEditable(false);
        timePicker(field);
        return field;
